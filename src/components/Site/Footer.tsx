import AudioNotificationsToggle from '@/components/Site/AudioNotificationsToggle';
...
import WebNotificationsToggle from '@/components/Site/WebNotificationsToggle';
...
export default function Footer() {
  return (
    <footer className='flex items-center gap-2 text-slate-500 text-[8pt] sm:text-sm py-2 pwa:py-3 px-4 pwa:px-8 mt-4 sticky bottom-0 bg-white border-t border-slate-400 shadow-sm'>
      <ConnectionStatus />
      <WebNotificationsToggle />
      <AudioNotificationsToggle />
